...
public class HomeVideoviewAdapter extends RecyclerView.Adapter<HomeVideoviewAdapter.MyviewHolder>   {
    ...
    HomeVideoviewAdapter(ArrayList<Model> arrayList, Context context){
    ...
    @NonNull
    @Override
    public HomeVideoviewAdapter.MyviewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, final int i) {
        view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.homevideoitem,viewGroup,false);
        final HomeVideoviewAdapter.MyviewHolder myviewHolder = new HomeVideoviewAdapter.MyviewHolder(view);
    ...
    @Override
    public void onBindViewHolder(@NonNull HomeVideoviewAdapter.MyviewHolder myviewHolder, int i) {
