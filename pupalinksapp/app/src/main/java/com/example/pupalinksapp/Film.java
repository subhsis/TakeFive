...
public class Film extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        filmview = findViewById(R.id.filmview);
        jsonAd();
    ...
    private void setrecycleview2(ArrayList<Model> arrayList) {
        ...
        filmview.setItemAnimator(new DefaultItemAnimator());
        filmview.setLayoutManager(new GridLayoutManager(this,2));
        viewAdapterfilm = new ViewAdapter(arrayList, this);
        viewAdapterfilm.notifyDataSetChanged();
        filmview.setAdapter(viewAdapterfilm);
    }
}
